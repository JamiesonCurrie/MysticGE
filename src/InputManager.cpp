...
namespace Input {
	...
	void InputManager::initialise( const Ogre::RenderWindow& renderWindow )
	{
		mInputDeviceManager	= InputDeviceManager::getSingletonPtr();
		mInputWatcher		= InputWatcher::getSingletonPtr();
		
		mInputDeviceManager->initialise(renderWindow);
		mInputDeviceManager->setKeyboardEventListener(mInputWatcher);
		mInputDeviceManager->setMouseEventListener(mInputWatcher);
		mInputDeviceManager->setJoyStickEventListener(mInputWatcher);
